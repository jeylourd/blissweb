   ...
   <!-- The Modal -->
    ...
    <div class="modal-dialog">
        ...
        <form action="" method="post">
                ...
                <input type="text" class ="form-control input-sm" id="newposition" name="newposition" placeholder = "Position" required><br>
          ...
          foreach ($result as $print) {
            echo "
              <tr>
                ...
                <td width='25%'><a href='admin.php?page=new-entry&upt=$print->tileview_id'><button type='button' class ='btn btn-warning btn-sm'><i class='bi bi-pencil'></i></button></a> <a href='admin.php?page=new-entry&del=$print->tileview_id'><button type='button' class ='btn btn-danger btn-sm'><i class='bi bi-trash'></i></button></a></td>
              </tr>
            ";
          }
        ?>
